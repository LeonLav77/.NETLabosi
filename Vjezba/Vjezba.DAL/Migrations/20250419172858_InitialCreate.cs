...
namespace Vjezba.DAL.Migrations
{
    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Clients",
                columns: new[] { "ID", "Address", "CityID", "CreatedById", "DateOfBirth", "Email", "FirstName", "Gender", "LastName", "PhoneNumber", "UpdatedById", "WorkingExperience" },
                values: new object[] { 1, "Ilica 1", 2, null, null, "lkardas@example.com", "Leon", 'M', "Kardas", "0912345678", null, 5 });
